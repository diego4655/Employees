...
- Create Angular project with ng: `ng new employeesfront.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`employeesfront.client.esproj`).
